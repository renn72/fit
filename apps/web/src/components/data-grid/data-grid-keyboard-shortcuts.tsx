			...
			>
				...
				<div className='px-6'>
					<div className='relative'>
						<SearchIcon className='absolute top-1/2 -translate-y-1/2 start-3 size-3.5 text-muted-foreground' />
						<Input
							ref={inputRef}
				...
				<div className='overflow-y-auto px-6 h-[40vh]'>
					{filteredGroups.length === 0 ? (
						<div className='flex flex-col gap-3 justify-center items-center h-full text-center'>
							<div className='flex justify-center items-center rounded-lg size-10 shrink-0 bg-muted text-foreground'>
