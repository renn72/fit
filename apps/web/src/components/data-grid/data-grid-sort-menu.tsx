    ...
    >
      <Popover open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          {sorting.length > 0 && (
            <SortableContent render={<div role="list" className="flex max-h-[300px] flex-col gap-2 overflow-y-auto p-1" />} nativeButton={false}>{sorting.map((sort) => (
                                        <DataTableSortItem
                                          key={sort.id}
                                          sort={sort}
...
function DataTableSortItem({
  ...
  return (
    <SortableItem value={sort.id} render={<div role="listitem" id={sortItemId} tabIndex={-1} className="flex items-center gap-2" onKeyDown={onItemKeyDown} />} nativeButton={false}><Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
              ...
              >
                <Trash2 />
              </Button><SortableItemHandle asChild>
                <Button
                  variant="outline"
                  size="icon"
                  className="size-8 shrink-0 rounded"
              ...
              </SortableItemHandle></SortableItem>
  );
}
