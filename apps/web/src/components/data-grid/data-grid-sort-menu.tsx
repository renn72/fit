		...
		>
			<Popover open={open} onOpenChange={setOpen}>
				...
				<PopoverContent
					...
					dir={dir}
					className='flex flex-col gap-3.5 p-4 w-full max-w-(--radix-popover-content-available-width) sm:min-w-[380px]'
					{...props}
				>
					...
					{sorting.length > 0 && (
						<SortableContent
							render={
								<div
									role='list'
									className='flex overflow-y-auto flex-col gap-2 p-1 max-h-[300px]'
								/>
							}
							nativeButton={false}
						>
			...
			<SortableOverlay>
				<div dir={dir} className='flex gap-2 items-center'>
					<div className='w-44 h-8 rounded-sm bg-primary/10' />
					<div className='w-24 h-8 rounded-sm bg-primary/10' />
			...
			<Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
				<PopoverTrigger asChild>
					<Button
						...
						variant='outline'
						size='sm'
						className='justify-between w-44 font-normal rounded'
					>
