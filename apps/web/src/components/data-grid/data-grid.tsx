	...
	return (
		...
		>
			...
			<div
				...
				tabIndex={0}
				ref={dataGridRef}
				className='grid overflow-auto relative rounded-md border select-none focus:outline-none'
				style={{
					...columnSizeVars,
					maxHeight: `${height}px`,
				}}
			...
			>
				<div
					...
					ref={headerRef}
					className='grid sticky top-0 z-10 border-b bg-background'
				>
								...
								return (
									...
									>
										{header.isPlaceholder ? null : typeof header.column
											...
											<div className='py-1.5 px-3 size-full'>
												{flexRender(
				...
				{!readOnly && onRowAdd && (
					<div
						...
						ref={footerRef}
						className='grid sticky bottom-0 z-10 border-t bg-background'
					>
						<div
							role='row'
						...
						>
							<div
								role='gridcell'
								tabIndex={0}
								className='flex relative items-center h-9 transition-colors focus:outline-none grow bg-muted/30 hover:bg-muted/50 focus:bg-muted/50'
								style={{
							...
							>
								<div className='flex sticky gap-2 items-center px-3 start-0 text-muted-foreground'>
