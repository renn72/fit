...
export function AppShell({ children, session }: AppShellProps) {
	...
	return (
		<div className='mx-auto flex h-[100dvh] w-full max-w-[430px] flex-col overflow-hidden border-x border-border/70 bg-card/80 shadow-[0_28px_80px_rgba(71,92,173,0.16)] backdrop-blur-xl'>
			<header className='shrink-0 border-b border-border/70 bg-background/86 backdrop-blur-xl'>
			...
			<footer className='shrink-0 border-t border-border/70 bg-background/92 px-3 py-3 backdrop-blur-xl'>
